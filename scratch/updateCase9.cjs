...
const idxStart = content.indexOf('case 9: {');
const idxEnd = content.indexOf('case 10: return');

if (idxStart !== -1 && idxEnd !== -1) {
    const oldCase = content.substring(idxStart, idxEnd);
    
    const newCase = `case 9: {
...
`;
    ...
    console.log("Successfully replaced case 9");
} else {
    console.log("Could not find bounds of case 9 and 10.");
}
