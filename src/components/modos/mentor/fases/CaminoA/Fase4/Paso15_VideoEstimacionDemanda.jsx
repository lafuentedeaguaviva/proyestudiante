...
const Paso15_VideoEstimacionDemanda = ({ setAyudanteText }) => {
  useEffect(() => {
    setAyudanteText("Finalmente, ¿cuánto vas a vender realmente? Mira este video para aprender a proyectar tus ventas reales.");
  }, [setAyudanteText]);
    ...
    <div style={{ padding: '2rem', color: '#0f172a', maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
        ...
        <p style={{ color: '#64748b', fontSize: '1.1rem' }}>
          Convierte clientes potenciales en ventas reales (proyección).
        </p>
      </div>
      ...
      <div style={{ background: 'white', padding: '2rem', borderRadius: '1rem', border: '1px solid #e2e8f0', textAlign: 'center' }}>
        <div style={{ 
          ...
          <span style={{ color: '#475569' }}>[ Video: Cómo estimar tus ventas reales ]</span>
        </div>
      </div>
    </div>
  );
...
export default Paso15_VideoEstimacionDemanda;
