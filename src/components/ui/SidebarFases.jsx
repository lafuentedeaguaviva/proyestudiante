  ...
  useEffect(() => {
    const fetchMaxFase = async () => {
      ...
      const mapaEstatico = [
        ...
        { id: 1, titulo: 'Encontrar la idea', path: '/fase/1', pasos: ['Selección de Área', 'Video: El Arte de observar problemas', 'Observación del Entorno', 'Video: ¿Por qué fallan las soluciones?', 'Análisis de Fricciones', 'Guía: Brainstorming Efectivo', 'Lluvia de Ideas', 'Video: Evaluación objetiva', 'Matriz de Batalla', 'Idea Ganadora y Pitch'] },
        { id: 2, titulo: 'Validación de la Idea', path: '/fase/2', pasos: ['Introducción a la Validación', 'Diseño de la Encuesta', 'Explicación de la Matriz', 'Codificación de Preguntas', 'Tabulación de Resultados', 'Análisis de Resultados', 'Resumen IA'] },
        { id: 3, titulo: 'Público Objetivo', path: '/fase/3', pasos: ['Video Público Objetivo', 'Público Objetivo'] },
        { id: 4, titulo: 'Diseño de producto o servicio', path: '/fase/4', pasos: [
          'Video Diseño Producto/Servicio', 'Qué vas a vender',
          'Video Características', 'Características', 'Beneficios', 'Video Empaque', 'Empaque',
          'Presentación', 'Video Demanda Potencial', 'Demanda Potencial', 'Resumen IA'
        ] },
        { id: 5, titulo: 'La Estrategia de Marketing', path: '/fase/5', pasos: [
          '1. Video: Análisis de competencia', '2. Análisis de competencia',
          '3. Video: Ventaja competitiva', '4. Tu Ventaja Competitiva', '5. Video: Análisis del entorno',
          '6. Análisis del entorno (Factores externos)', '7. Video: Estrategia de promoción', '8. Estrategia de promoción', '9. Resumen IA'
        ] },
        ...
        {isOpen && (
          ...
          >
            ...
            <div style={{ padding: '1.5rem', flex: 1 }}>
              ...
              {!isMentor && (
                <div style={{ marginTop: '3rem', padding: '1rem', background: 'rgba(220, 38, 38, 0.1)', border: '1px solid rgba(220, 38, 38, 0.3)', borderRadius: '0.5rem', display: 'flex', alignItems: 'center', gap: '1rem', cursor: 'not-allowed' }}>
                  <div style={{ width: '32px', height: '32px', borderRadius: '50%', background: '#7f1d1d', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fca5a5' }}>
                    <Lock size={16} />
                  </div>
                  <div>
                    <div style={{ color: '#ef4444', fontWeight: 'bold', fontSize: '1rem', letterSpacing: '1px' }}>
                      EXPEDIENTE Ω
                    </div>
                    <div style={{ color: '#fca5a5', fontSize: '0.75rem', textTransform: 'uppercase' }}>
                      ACCESO DENEGADO
                    </div>
                  </div>
                </div>
